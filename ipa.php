...
<head>
  ...
  <!-- Bootstrap CSS -->
  <?php include 'dashboard_tutor/cssnya.php' ?>
...
<body>
  ...
  <div class="row no-gutters mt-5">
    ...
    <!--bagian sisi kiri-->
    <?php include 'dashboard_tutor/sidebar.php' ?>

    <!--bagian sisi kanan-->
    <div class="col-md-10 p-5 pt-2">
      <h3><i class="fas fa-bookmark mr-2"></i>IPA</h3>
      <hr>
      <div class="row">
        <!--siswa pertama-->
        <div class="card mb-3 ml-5 shadow p-3 mb-5 bg-white rounded" style="max-width: 900px;">
          <div class="row no-gutters">
            <div class="col-md-4">
              <img src="assets/img/gambar1.jpg" class="card-img p-3" alt="...">
            </div>
            <div class="col-md-8">
            ...
            <table style="width: 980px;">
              <tr>
                <td rowspan="15" width="250px">
                  <img src="assets/img/gambar1.jpg" width="220px" height="220px" />
                </td>
              </tr>
              <tr>
                <td><b>Nama Lengkap</b></td>
  ...
  <?php include 'dashboard_tutor/jsnya.php' ?>
</body>
