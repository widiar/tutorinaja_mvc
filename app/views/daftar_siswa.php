    ...
    <div class="container">
        <div class="row">
            <div class="col-5">
                <br><br><br><br>
                <br>
                <h4 class="text-center">DAFTAR SEBAGAI SISWA</h4>
                <br>
                <img src="assets/img/data_storage.png" class="rounded mx-auto d-block" height="200px" width="250px">
                <br>
                <form>
                ...
                <a href="profile/siswa.php"><button type="submit" id="btnSubmit" class="btn btn-primary">SUBMIT</button><br></a>
            </div>
            <div class="col-6">
                <br><br><br><br><br>
