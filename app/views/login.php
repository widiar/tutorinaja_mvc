...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-info fixed-top" id="mainNav">
        <div class="container">
            ...
            <a class="navbar-brand font-weight-bold text-white" href="<?= BASEURL ?>"><i class="fab fa-accusoft mr-2"></i>Tutorin Aja!</a>
        </div>
    </nav>
    <div class="container">
        <div class="row">
            <div class="col-5">
                ...
                <br>
                <img src="<?= BASEURL ?>/img/product_manager.png" class="rounded mx-auto d-block" height="200px" width="250px">
                <br><br>
                <form>
                ...
                <a class="btn btn-primary" href="dashboard_tutor" role="button">SUBMIT</a>
            </div>
            <div class="col-6">
                <br><br><br>
                <img src="<?= BASEURL ?>/img/video_tutorial_.png" width="700px" height="auto" class="mt-4">
            </div>
        </div>
    </div>
